...
df["lactose_intolerant"].value_counts().plot(kind="bar")
...
df["rs4988235_genotype"].value_counts().plot(kind="bar")

plt.title("Genotype Distribution")
plt.xlabel("Genotype")
plt.ylabel("Count")

plt.savefig("plots/genotype_distribution.png")
...
df.boxplot(column="symptoms_score", by="rs4988235_genotype")
...
plt.savefig("plots/symptoms_by_genotype.png")
...
intolerance_by_genotype.plot(kind="bar")
